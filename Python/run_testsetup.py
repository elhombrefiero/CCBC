...
if __name__ == "__main__":
    ...
    T1 = TemperatureSensor("Test Setup 1", "28FF6AB585160484", 999)
    T2 = TemperatureSensor("Test Setup 2", "28FFAC378217045A", 999)
    ...
    for pump in pumps:
        ...
        ard_dict['pumps'][pump.name]['lower limit'] = pump.gallon_setpoint*0.95
